<%-- 
    Document   : ListarCompraProduc
    Created on : 24-nov-2018, 16:14:59
    Author     : Kevin Damian
--%>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <table class="table-striped display" id="tabla">
                        ...
                        <tbody>
                            <% for(MODEL.DetalleCompra dt:DAO.DetalleCompraDAO.listar()) { %>
                            <tr>
                            <td width='5' > <%= dt.getIddetallecompra()  %></td>
                            <td width='5'> <%=dt.getPrecio()  %></td>
                            <td width='5'> <%=dt.getCantidad()%></td>
                            <td width='5'> <%=dt.getTotal()%></td>
                            <td width='5'> <%=dt.getIdproducto()%></td>                         
                            <td width='5'> <%=dt.getIdproveedor()%></td>
      ...
      <div class="modal-body">
        <!-- 4:3 aspect ratio -->
                <div class="embed-responsive embed-responsive-4by3">
                  <iframe class="embed-responsive-item" src="RegistrarNuevaCompra.jsp"></iframe>
                </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-info" data-dismiss="modal" onclick= "self.location.href = 'ListarCompraProduc.jsp'">Salir </button>
