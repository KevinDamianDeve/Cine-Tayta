<%-- 
    ...
    Created on : 28-nov-2018, 12:06:59
    Author     : Kevin Damian
--%>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <table class="table-striped display" id="tabla">
                        ...
                        <tbody>
                            <% for(MODEL.Proveedor p:DAO.ProveedorDAO.listar()) { %>
                            <tr>
                            <td width='5' > <%= p.getIdproveedor()%></td>
                            <td width='5'> <%= p.getNombre()%> </td>
                            <td width='5'> <%=p.getDireccion()%></td>
                            <td width='5'> <%=p.getTelefono()%></td>

                           
                            
                             <td>
                                     <a href="Servleteliminarproveedor?cod=<%=p.getIdproveedor()%>">
                                     <input type="submit" value="Eliminar"
                                            class="btn btn-danger btn-sm"></a>
                                            
                                            
                                     <a href="modificarproveedor.jsp?cod=<%=p.getIdproveedor()%>">       
      ...
      <div class="modal-body">
        <!-- 4:3 aspect ratio -->
                <div class="embed-responsive embed-responsive-4by3">
                  <iframe class="embed-responsive-item" src="RegistrarProveedor.jsp"></iframe>
                </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-info" data-dismiss="modal" onclick= "self.location.href = 'Listarproveedor.jsp'">Salir </button>
        ...
        <div class="container" >
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <% MODEL.Proveedor p=DAO.ProveedorDAO.getIdproveedor(sid); %>
                    ...
                    <table class="table table-striped">
                        <form name="form1" method="post" action="Servletmodificarproveedor" >
                            <tr>
                                <td>Codigo</td>
                                <td>
                                    <select  name="cod" class="form-control"required>
                                    <% for(MODEL.Proveedor cat:DAO.ProveedorDAO.listar()){ %>
                                    <option> <%=cat.getIdproveedor()%></option>
                                    <% } %>
                                    </select>                                    
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Direccion</td>
                                <td><input type="text" name="dir" class="form-control" 
                                           value="<% out.println(p.getDireccion()); %>" ></td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2" > <input type="submit" value="Modificar Proveedor"
