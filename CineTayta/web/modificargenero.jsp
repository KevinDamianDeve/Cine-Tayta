<%-- 
    ...
    Created on : 27-nov-2018, 12:22:32
    Author     : Kevin Damian
--%>
      ...
      <div class="container" >
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <% MODEL.Genero p=DAO.GeneroDAO.getIdGenero(sid); %>
                    ...
                    <table class="table table-striped">
                        <form name="form1" method="post" action="Servletmodificargenero" >
                            <tr>
                                <td>Codigo</td>
                                <td>
                            ...
                            <tr>
                                <td>Genero</td>
                                <td><input type="text" name="gen" class="form-control" 
                                           value="<% out.println(p.getGenero()); %>" ></td>
                            </tr>
   
                            
                            <tr>
                                <td colspan="2" > <input type="submit" value="Modificar Genero"
