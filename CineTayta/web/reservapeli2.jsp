<%-- 
    Document   : reservapeli2
    Created on : 07-dic-2018, 18:57:20
    Author     : Kevin Damian
--%>
         ...
         <div class="container" >
            <div class="row" >
                ...
                <div class="col-lg-11">
                     ...
                     <table class="table table-striped table-bordered table-responsive-md" id="tabla">
                        <thead>
                            <tr class="bg-success" >
                                <th>Codigo</th>
                                <th>Documento</th>                               
                        ...
                        <tbody>
                            ...
                            <td width='5'> <%=p.getIdusuario()%></td>
                             <td>
                                     <a href="ticket2.jsp?cod=<%=p.getIdventa()%>">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-info" data-dismiss="modal" onclick= "self.location.href = 'reservapeli2.jsp'">Salir </button>
