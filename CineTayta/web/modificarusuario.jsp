<%-- 
    ...
    Created on : 27-nov-2018, 19:09:10
    Author     : Kevin Damian
--%>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <table class="table-striped display" id="tabla">
                        ...
                        <tbody>
                            <% for(MODEL.Usuario p:DAO.UsuarioDAO.listar()) { %>
                            <tr>
                            <td width='5' > <%= p.getIdusuario()%></td>
                            <td width='5'> <%= p.getNombre()%> </td>
                            <td width='5'> <%=p.getTelefono()%></td>
                            <td width='5'> <%=p.getDni()%></td>
                            <td width='5'> <%=p.getCargo()%></td>
                            <td width='5'> <%=p.getUsuario()%></td>                         
                            <td width='5'> <%=p.getContraseña()%></td>
                            <td width='5'> <%=p.getNivel()%></td>

                           
                            
                             <td>
                                     <a href="Servleteliminarusu?cod=<%=p.getIdusuario()%>">
                                     <input type="submit" value="Eliminar"
                                            class="btn btn-danger btn-sm"></a>
                                            
                                            
                                     <a href="modificarusuario.jsp?cod=<%=p.getIdusuario()%>">       
      ...
      <div class="modal-body">
        <!-- 4:3 aspect ratio -->
                <div class="embed-responsive embed-responsive-4by3">
                  <iframe class="embed-responsive-item" src="RegistrarUsuario.jsp"></iframe>
                </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-info" data-dismiss="modal" onclick= "self.location.href = 'ListarUsuaro.jsp'">Salir </button>
        ...
        <div class="container" >
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <% MODEL.Usuario p=DAO.UsuarioDAO.getIdUsuario(sid); %>
                    ...
                    <table class="table table-striped">
                        <form name="form1" method="post" action="Servletmodificarusu" >
                            <tr>
                                <td>Codigo</td>
                                <td>
                                    <select  name="cod" class="form-control"  readonly="">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="tel" class="form-control" 
                                           value="<% out.println(p.getTelefono()); %>" ></td>
                            </tr>
                            
                            <tr>
                                <td>DNI</td>
                                <td><input type="text" name="dn" class="form-control" 
                                           value="<% out.println(p.getDni()); %>" ></td>
                            </tr>
                            <tr>
                                <td>Cargo</td>
                                <td><input type="text" name="car" class="form-control" 
                                           value="<% out.println(p.getCargo()); %>" ></td>
                            </tr>
                            
                            <tr>
                                <td>Usuario</td>
                                <td><input type="text" name="usu" class="form-control" 
                                           value="<% out.println(p.getUsuario()); %>" ></td>
                            </tr>
                           
                            
                            <tr>
                                <td>Contraseña</td>
                                <td><input type="text" name="con" class="form-control" 
                                           value="<% out.println(p.getContraseña()); %>" ></td>
                            </tr>
                            <tr>
                                <td>Nivel</td>
                                <td><input type="text" name="niv" class="form-control" 
                                           value="<% out.println(p.getNivel()); %>" ></td>
                            </tr>
