<%-- 
    Document   : ventapelicula
    Created on : 07-dic-2018, 20:37:45
    Author     : Kevin Damian
--%>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-info" data-dismiss="modal" onclick= "self.location.href = 'ventapelicula.jsp'">Salir </button>
