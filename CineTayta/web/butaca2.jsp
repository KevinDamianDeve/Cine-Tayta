<%-- 
    Document   : butaca2
    Created on : 07-dic-2018, 18:06:49
    Author     : Kevin Damian
--%>
            ...
            <div class="row" >
                ...
                <div class="col-lg-12">
                    ...
                    <% MODEL.Butaca p=DAO.ButacaDAO.getNButaca(sid); %>
                        ...
                        <form name="form1" method="post" action="Serveletmodificarbut2" >
                           <%--
                            <tr>
                                <td>N Butaca</td>
                                <td>
                            ...
                            <tr>
                        <div>
                            <center> <button onclick="location.href='butaca2.jsp'"class="btn btn-outline-primary" >Cambiar</button></center>
                        </div> 
                            </tr>
                                    </div>
                                </div>
