<%-- 
    Document   : modificarbutaca
    Created on : 28-nov-2018, 0:07:56
    Author     : Kevin Damian
--%>
                    ...
                    <table class="table-striped display" id="tabla">
                        ...
                        <tbody>
                            ...
                            <td width='5'> <%= p.getEstado()%> </td>
                             ...
                             <td>
                                     <a href="Servleteliminarbut?cod=<%=p.getNbutaca()%>">
                                     <input type="submit" value="Eliminar"
                                            class="btn btn-danger btn-sm"></a>
                                            
                                            
                                     <a href="modificarbutaca.jsp?cod=<%=p.getNbutaca()%>">       
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Registrar Butacas</h5>
         </div>
      <div class="modal-body">
        <!-- 4:3 aspect ratio -->
                <div class="embed-responsive embed-responsive-4by3">
                  <iframe class="embed-responsive-item" src="Registrarbutacas.jsp"></iframe>
                </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-info" data-dismiss="modal" onclick= "self.location.href = 'Listarbutacas.jsp'">Salir </button>
        ...
        <div class="container" >
            <div class="row">
                <div class="col-lg-6">
                     <h3>DATOS DE BUTACA</h3>
                    <% String sid=request.getParameter("n"); %>
                    <% MODEL.Butaca p=DAO.ButacaDAO.getNButaca(sid); %>
                    ...
                    <table class="table table-striped">
                        <form name="form1" method="post" action="Servletmodificarbut" >
                           <tr>
                                <td>N Butaca</td>
                                <td>
                            ...
                            <tr>
                                <td colspan="2" > <input type="submit" value="Modificar Butaca"
