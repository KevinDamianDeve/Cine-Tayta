<%-- 
    Document   : modificarsala
    Created on : 27-nov-2018, 13:21:27
    Author     : Kevin Damian
--%>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <table class="table-striped display" id="tabla">
                        ...
                        <tbody>
                            <% for(MODEL.Sala p:DAO.SalaDAO.listar()) { %>
                            <tr>
                            <td width='5' > <%= p.getNsala()%></td>
                            <td width='5'> <%= p.getCapacidad()%> </td>
                        
                           
                            
                             <td>
                                     <a href="Servleteliminarsala?cod=<%=p.getNsala()%>">
                                     <input type="submit" value="Eliminar"
                                            class="btn btn-danger btn-sm"></a>
                                            
                                            
                                     <a href="modificarsala.jsp?cod=<%=p.getNsala()%>">       
      ...
      <div class="modal-body">
        <!-- 4:3 aspect ratio -->
                <div class="embed-responsive embed-responsive-4by3">
                  <iframe class="embed-responsive-item" src="Registrarsala.jsp"></iframe>
                </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-info" data-dismiss="modal" onclick= "self.location.href = 'ListarSalas.jsp'">Salir </button>
      ...
      <div class="container" >
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <% MODEL.Sala p=DAO.SalaDAO.getNSala(sid); %>
                    ...
                    <table class="table table-striped">
                        <form name="form1" method="post" action="Servletmodificarsala" >
                            <tr>
                                <td>N Sala</td>
                                <td>
                            ...
                            <tr>
                                <td>Capacidad</td>
                                <td><input type="text" name="cap" class="form-control" 
                                           value="<% out.println(p.getCapacidad()); %>" ></td>
                            </tr>
   
                            
                            <tr>
                                <td colspan="2" > <input type="submit" value="Modificar Sala"
