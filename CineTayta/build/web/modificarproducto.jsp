<%-- 
    ...
    Created on : 24-nov-2018, 16:04:33
    Author     : Kevin Damian
--%>
                    ...
                    <table class="table-striped display" id="tabla">
                        ...
                        <tbody>
                            ...
                            <td width='5'> <%=p.getObservacion()%></td>
                             ...
                             <td>
                                     <a href="Servleteliminarproduc?cod=<%=p.getIdproducto()%>">
                                     <input type="submit" value="Eliminar"
                                            class="btn btn-danger btn-sm"></a>
                                            
                                            
                                     <a href="modificarproducto.jsp?cod=<%=p.getIdproducto()%>">       
      ...
      <div class="modal-body">
        <!-- 4:3 aspect ratio -->
                <div class="embed-responsive embed-responsive-4by3">
                  <iframe class="embed-responsive-item" src="Registrarproducto.jsp"></iframe>
                </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-info" data-dismiss="modal" onclick= "self.location.href = 'Listarproductos.jsp'">Salir </button>
        ...
        <div class="container" >
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <% MODEL.Producto p=DAO.ProductoDAO.getIdproducto(sid); %>
                    ...
                    <table class="table table-striped">
                        <form name="form1" method="post" action="Servletmodificarpro" >
                            <tr>
                                <td>Codigo</td>
                                <td>
                                    <select  name="cod" class="form-control"required>
                                    <% for(MODEL.Producto cat:DAO.ProductoDAO.listar()){ %>
                                    <option> <%=cat.getIdproducto()%></option>
                                    <% } %>
                                    </select> 
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="des" class="form-control" 
                                           value="<% out.println(p.getDescripcion()); %>" ></td>
                            </tr>
                            ...
                            <tr>
                                <td>Precio</td>
                                <td><input type="text" name="pr" class="form-control" 
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="st" class="form-control" 
                                           value="<% out.println(p.getStock()); %>" ></td>
                            </tr>
                            <tr>
                                <td>Fecha Vencimiento</td>
                                <td><input type="text" name="f" class="form-control" 
                                           value="<% out.println(p.getFechav()); %>" ></td>
                            </tr>
                            
                            <tr>
                                <td>Presentacion</td>
                                <td><input type="text" name="pres" class="form-control" 
                                           value="<% out.println(p.getPresentacion()); %>" ></td>
                            </tr>
                           
                            
                            <tr>
                                <td>Estado</td>
                                <td><input type="text" name="est" class="form-control" 
                                           value="<% out.println(p.getEstado()); %>" ></td>
                            </tr>
                            <tr>
                                <td>Observacion</td>
                                <td><input type="text" name="obs" class="form-control" 
                                           value="<% out.println(p.getObservacion()); %>" ></td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2" > <input type="submit" value="Modificar Producto"
