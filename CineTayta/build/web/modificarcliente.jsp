...
<%-- 
    ...
    Created on : 29-nov-2018, 12:38:20
    Author     : Kevin Damian
--%>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <table class="table-striped display" id="tabla">
                        ...
                        <tbody>
                            <% for(MODEL.Cliente p:DAO.ClienteDAO.listar()) { %>
                            <tr>
                            ...
                            <td width='5'> <%=p.getDni()%></td>
                             ...
                             <td>
                                     <a href="Servleteliminarcliente?cod=<%=p.getIdcliente()%>">
                                     <input type="submit" value="Eliminar"
                                            class="btn btn-danger btn-sm"></a>
                                            
                                            
                                     <a href="modificarcliente.jsp?cod=<%=p.getIdcliente()%>">       
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-info" data-dismiss="modal" onclick= "self.location.href = 'Listarcliente.jsp'">Salir </button>
        ...
        <div class="container" >
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <% MODEL.Cliente p=DAO.ClienteDAO.getICliente(sid); %>
                    ...
                    <table class="table table-striped">
                        <form name="form1" method="post" action="Servletmodificarcliente" >
                            <tr>
                                <td>Codigo</td>
                                <td>
                            ...
                            <tr>
                                <td colspan="2" > <input type="submit" value="Modificar Cliente"
