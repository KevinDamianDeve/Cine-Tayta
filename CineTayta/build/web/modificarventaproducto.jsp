<%-- 
    Document   : modificarventaproducto
    Created on : 30-nov-2018, 14:34:21
    Author     : Kevin Damian
--%>
                        ...
                        <tbody>
                            ...
                            <td width='5'> <%=p.getIdusuario()%></td>
                             ...
                             <td>
                                     ...
                                     <a href="modificarventaproducto.jsp?cod=<%=p.getIdventapro()%>">       
              ...
              <!-- Button trigger modal -->
                <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#exampleModal">
                  Registrar Nueva Venta
                        ...
                        <br>
                      <%--
                            <button onclick="location.href='ListarDetalleVentaProducto.jsp'"class="btn btn-outline-primary" >Realizar la Venta</button>
--%>                        
</div>      
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-info" data-dismiss="modal" onclick= "self.location.href = 'ListarVentaProductos.jsp'">Salir </button>
        ...
        <div class="container" >
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <% MODEL.Ventapro p=DAO.VentaproDAO.getIdVentapro(sid); %>
                    ...
                    <table class="table table-striped">
                        <form name="form1" method="post" action="Servletmodifiventaproducto" >
                            <tr>
                                <td>Codigo</td>
                                <td>
                                    <select  name="cod" class="form-control"required>
                                    <% for(MODEL.Detalle_ventapro cat:DAO.DetalleVentaProDAO.listar()){ %>
                                    <option> <%=cat.getIddetalle_ventapro()%></option>
                                    <% } %>
                                    </select> 
                                </td>
                            </tr>
                            <tr>
                                <td>Serie</td>
                                <td><input type="text" name="ser" class="form-control" 
                                           value="<% out.println(p.getSerie()); %>" ></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="est" class="form-control" 
                                           value="<% out.println(p.getEstado()); %>" readonly=""></td>
                            </tr>
                            
                            <tr>
                                <td>Sub Total</td>
                                <td><input type="text" name="st" class="form-control" 
                                           value="<% out.println(p.getSub_total()); %>" ></td>
                            </tr>
                            <tr>
                                <td>IGV</td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="tp" class="form-control" 
                                           value="<% out.println(p.getIdtipo_documento()); %>" ></td>
                            </tr>
