<%-- 
    Document   : ListarDetalleVentaPelicula
    Created on : 30-nov-2018, 9:48:16
    Author     : Kevin Damian
--%>
         ...
         <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <table class="table-striped display" id="tabla">
                        ...
                        <tbody>
                            ...
                            <tr>
                            <td width='5' > <%=dt.getIddetalle_ventape()%></td>
                            <td width='5'> <%=dt.getPrecio()%></td>
                            <td width='5'> <%=dt.getCantidad()%></td>
                            <td width='5'> <%=dt.getValor_venta()%></td>
                            <td width='5'> <%=dt.getIdventa()%></td>                         
                            <td width='5'> <%=dt.getIdpelicula()%></td>
                            <td width='5' > <%=dt.getNbutaca()%> </td>
                ...
                <div class="col-lg-6">
                    ...
                    <table class="table-striped " id="tabla1">
                        <thead>
                            <tr class="bg-success" border="1" >
                                <th >N Butaca</th>
                                <th>Estado</th>                                
                        ...
                        <tbody>
                            <% for(MODEL.Butaca p:DAO.ButacaDAO.listar()) { %>
                            <tr>
                            <td width='5' > <%= p.getNbutaca()%></td>
                ...
                <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#exampleModal">
                  Registrar Nuevo
                         ...
                         <div class="container-fluid" >
                            ...
                            <div class="col-lg-2" >
                                    <label for="msje" ><h5>Mostrar Butacas</h5></label>
                        ...
                        <br>
                     <%-- <div>
                            <button onclick="location.href='Listarproductos.jsp'"class="btn btn-outline-primary" >Productos</button>
                        </div>    --%>   
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Registrar Nuev</h5>
         </div>
      <div class="modal-body">
        <!-- 4:3 aspect ratio -->
                <div class="embed-responsive embed-responsive-4by3">
                  <iframe class="embed-responsive-item" src="RegistrarNuevodetallepeli.jsp"></iframe>
                </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-info" data-dismiss="modal" onclick= "self.location.href = 'ListarDetalleVentaPelicula.jsp'">Salir </button>
